...
from agents.nodes.customer_validation import customer_validation_node
...
def build_graph():
    ...
    graph.add_node("customer_validation_node", customer_validation_node)
    ...
    graph.add_edge("competitors_node", "customer_validation_node")
    graph.add_edge("customer_validation_node", "website_node")
    graph.add_edge("website_node", "funding_node")
